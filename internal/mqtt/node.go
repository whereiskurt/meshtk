...
/* This file was inspired by the meshmap project and Copyright (C) 2024 Brian Shea
      https://github.com/brianshea2/meshmap.net

	Specifically this file:
	  https://github.com/brianshea2/meshmap.net/blob/main/internal/meshtastic/node.go
*/
